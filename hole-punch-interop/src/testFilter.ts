 ...
 *
 * @param name - The test name to check
 * @param options - Filter options including nameFilter, nameIgnore, and verbose
 * @param collectMode - When true, suppresses all console output (useful for collecting tests silently)
 */
export function matchesFilter(
    ...
    // Only output to console if not in collect mode
    if (!collectMode) {
        if (verbose) {
