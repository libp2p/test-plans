...
export declare function encode0(message: MessageBuffer): Uint8ArrayList;
export declare function encode1(message: MessageBuffer): Uint8ArrayList;
export declare function encode2(message: MessageBuffer): Uint8ArrayList;
