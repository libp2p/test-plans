/* eslint-env mocha */
import { EventTypes, MessageType } from '@libp2p/kad-dht';
...
describe('peer-routing', () => {
    ...
    describe('via dht router', () => {
        ...
        before(async () => {
            ...
            // Ring dial
            await Promise.all(nodes.map(async (peer, i) => peer.dial(nodes[(i + 1) % nodes.length].peerId)));
        });
        after(() => {
            sinon.restore();
        });
...
//# sourceMappingURL=peer-routing.node.js.map