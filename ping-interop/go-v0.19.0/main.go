...
func runPing(runenv *runtime.RunEnv, initCtx *run.InitContext) error {
	...
	out, _ := json.Marshal(runenv)
	runenv.RecordMessage("run env value=%s", out)
	...
	runenv.RecordMessage("start MustWaitAllInstancesInitialized")
	initCtx.MustWaitAllInstancesInitialized(ctx)
	runenv.RecordMessage("done MustWaitAllInstancesInitialized")
