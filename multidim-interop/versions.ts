...
import rustBumpYamux from "./impl/rust/bump-yamux/image.json"
// import jsV041 from "./impl/js/v0.41/node-image.json"
// import jsV042 from "./impl/js/v0.42/node-image.json"
import jsHead from "./impl/js/head/node-image.json"
...
export const versions: Array<Version> = [
    {
        id: "rust-bump-yamux",
        containerImageID: rustBumpYamux.imageID,
        transports: ["tcp"],
    ...
    {
        id: "js-head",
        containerImageID: jsHead.imageID,
        transports: ["tcp"],
        secureChannels: ["noise"],
        muxers: ["yamux"],
    },
